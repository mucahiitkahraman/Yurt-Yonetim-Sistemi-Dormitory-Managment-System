...
?>
<!DOCTYPE html>
<html lang="<?php echo $selected_language == 'english' ? 'en' : 'tr'; ?>">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title><?php echo $lang['title']; ?></title>
    <link rel="stylesheet" href="anasayfa.css?v=<?php echo time()?>">
    <link rel="stylesheet" href="style_anasayfa.css?v=<?php echo time()?>">
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="altyazi">
            <div class="welcome"><?php echo $lang['welcome']; ?> <?php echo $_SESSION['kullaniciAdi']; ?><br/>
            </div>
            <div class="alt">
                <?php echo $lang['alt']; ?>
            </div>
            ...
            var tarihDiv = document.getElementById("tarih");
            ...
            var ayAdi = aylar[ay - 1]; 

            
            var yil = simdikiTarih.getFullYear();

            
            var tarihYaz = gun + " " + ayAdi + " " + yil;

            
            tarihDiv.innerHTML = tarihYaz;

        </script>
    </div>
</div>
<form class="sagust" action="anasayfa.php" method="POST">
