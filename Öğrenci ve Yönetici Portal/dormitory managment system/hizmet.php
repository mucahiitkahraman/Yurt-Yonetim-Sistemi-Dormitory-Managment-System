...
$query = "SELECT yurt_ID, yurtAdi FROM yurtlar";
...
<head>
    ...
    <link rel="stylesheet" href="hizmet1.css?v=<?php echo time()?>">
</head>
<div>
...
<div class="container">
    ...
    <div class="content">
        <div class="hizmet">
            <form action="hizmetkarsilastirma.php" method="post">
                <label for="dorm1"><?php echo $lang['dorm1_label']; ?></label>
                <select name="dorm1" id="dorm1">
                    <?php foreach ($yurtlar as $yurt) { ?>
                        <option value="<?php echo $yurt['yurt_ID']; ?>"><?php echo $yurt['yurtAdi']; ?></option>
                    <?php } ?>
                </select>
                <br>
                <label for="dorm2"><?php echo $lang['dorm2_label']; ?></label>
                <select name="dorm2" id="dorm2">
                    <?php foreach ($yurtlar as $yurt) { ?>
                        <option value="<?php echo $yurt['yurt_ID']; ?>"><?php echo $yurt['yurtAdi']; ?></option>
                    <?php } ?>
                </select>

                <button type="submit"><?php echo $lang['compare']; ?></button>
            </form>  
        </div>   
    </div> 
</div>

<form class="sagust" action="hizmet.php" method="POST">
